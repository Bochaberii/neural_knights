...
class MotorDriver(Node):
    ...
    def __init__(self):
        ...
        # Give the Arduino a moment to reset after opening the serial port
        time.sleep(2.0)
        try:
            # Clear any initial data sent by the Arduino boot/reset messages
    ...
    def send_command(self, cmd_string):
        ...
        try:
            ...
            c = ''
            value = ''
            # Accept either CR (\r) or LF (\n) as the end-of-line marker to be robust
            while c != '\r' and c != '\n':
            ...
            # Strip both CR and LF from the response
            value = value.strip('\r\n')
